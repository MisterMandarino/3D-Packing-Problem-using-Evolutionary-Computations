...
parser.add_argument('-W', '--WIDTH', type=float, required=True, help='The Width of the container')
parser.add_argument('-H', '--HEIGHT', type=float, required=True, help='The Height of the container')
